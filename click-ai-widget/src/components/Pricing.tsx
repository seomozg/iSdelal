        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tariffs.map((tariff, i) => (
            <motion.div
              ...
              className={`relative bg-card rounded-2xl p-6 shadow-sm border ${
                tariff.highlight
            ...
            >
              ...
              {tariff.isContact ? (
                ...
                <a
                  href="/login"
                  className="block w-full mt-5 py-2.5 text-center text-sm font-medium bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 transition-colors"
                >
                  {isRu ? "Начать бесплатно" : "Start Free"}
                </a>
              )}
